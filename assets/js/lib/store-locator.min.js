	...
	*/
	...
	storeLocator.Panel = function(a, b) {
		...
		this.settings_ = $.extend({
			locationSearch: !0,
			locationSearchLabel: "Enter Zip Code or City",
			featureFilter: !0,
			directions: !0,
			view: null
		}, b);
	...
	storeLocator.Panel.prototype.init_ = function() {
		...
		this.settings_.locationSearch && (this.locationSearch_ = $('\x3cdiv class\x3d"location-search"\x3e\x3cp\x3e' + this.settings_.locationSearchLabel + "\x3c/p\x3e\x3cinput\x3e\x3c/div\x3e"), this.filter_.append(this.locationSearch_), "undefined" != typeof google.maps.places ? this.initAutocomplete_() :
	...
	storeLocator.Panel.NO_STORES_HTML_ = '\x3cli class\x3d"no-stores"\x3elocations are listed below.\x3c/li\x3e';
	storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '\x3cli class\x3d"no-stores"\x3elocations are listed below.\x3c/li\x3e';
		...
		if (this.get("stores")) {
			var a = this.get("view"),
				...
				c = c.sort(function(a,b) {
					  var nameA = a.props_.title.toUpperCase(); // ignore upper and lowercase
					  var nameB = b.props_.title.toUpperCase(); // ignore upper and lowercase
					  if (nameA < nameB) {
					    return -1;
					  }
					  if (nameA > nameB) {
			...
			for (var b = function() {
				...
				}, e = 0, f = Math.min(500, c.length); e < f; e++) {
